...
{
    public partial class FrmPwdGenBox : Form
    {
        public EditItem parent { get; set; }
        public FrmPwdGenBox()
        {
            InitializeComponent();
        ...
        public void ColorReload()
        {
            ...
            BtnSave.BackColor = Properties.Settings.Default.AccentColor;
        }
